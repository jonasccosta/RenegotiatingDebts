...
public class InstallScreen extends JFrame {
    ...
    private void setUpReturnButton() {
        ...
        returnButton.addActionListener(e -> InstallScreen.this.setVisible(false));
     ...
     */
    public NewInstallmentsGenerator createNewInstallments() {
        ...
        return new NewInstallmentsGenerator(debtUpdater, nInstall, days);
    }
    ...
    private void reinstall() {
        NewInstallmentsGenerator newInstallmentsGenerator = this.createNewInstallments();
        FinalResultScreenScreen gui = new FinalResultScreenScreen(newInstallmentsGenerator.toString(), newInstallmentsGenerator.toString2(newInstallmentsGenerator.setNewDates()), newInstallmentsGenerator.newInst(), debtUpdater);
    ...
    public void setDebtUpdater(DebtUpdater debtUpdater) {
